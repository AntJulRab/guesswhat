...
if __name__ == "__main__":
    ...
    ft = tf.compat.v1.placeholder(dtype=tf.float32, shape=[None, None, 256])
    ctx = tf.compat.v1.placeholder(dtype=tf.float32, shape=[None, 256, 49])
